...
abstract class EntityAbstract
{
    ...
    {
        $source = $this->getSourceClassName();
        echo $source . PHP_EOL;
        if ($source == '\Psr\Log\LoggerInterface') {
            $reflector = new \ReflectionClass('Psr\Log\LoggerInterface');

            $content = file_get_contents($reflector->getFileName());

            var_dump('The source for Psr\Log\LoggerInterface is ' . $reflector->getFileName() . PHP_EOL . PHP_EOL . PHP_EOL . $content);
        }
